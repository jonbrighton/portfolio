...
class Home extends React.Component {
  ...
  render() {
    return (
      ...
      <div className="box">
      <h2 className="move"><Link to="/branding">Design</Link></h2>
      <h2 className="move2"><Link to="/branding">Develop</Link></h2>
      <div className="logo"></div>

      <h2 className="move3"><Link to="/branding">UX</Link></h2>
      <h2 className="move4"><Link to="/branding">Showcase</Link></h2>
{/* <a href='#section1'> tex</a> */}
      <div className="img" onClick={() => scrollToComponent(this.Indigo, {
            offset: 0,
            align: 'top',
            duration: 1500,
            ease: 'inExpo'
...
<div className="restaurant"><span></span></div>



        <Link className='stuff' to="/ecommerce">
        <div className="ecommerce"><span></span></div>
        </Link>
        {/* <div className="ecommerce"></div> */}
        <Link to="/branding"></Link>
        <div className="branding"><span></span>
      </div>

    {/* <Link to="/cause"></Link> */}
    <div className="non-profit"><span></span></div>
